...
export default function Header() {
    return (
      ...
      <div className="flex gap-4 border border-black-400 rounded py-2 pl-4 pr-4 shadow-lg shadow-black-400 items-center justify-around">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" />
      ...
      <Link to={'/login'} className="flex gap-2 border border-black-400 rounded py-2 pl-5 pr-4 shadow-lg items-center">
